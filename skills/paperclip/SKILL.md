...
- **Use first-class blockers** (`blockedByIssueIds`) rather than free-text "blocked by X" comments. Full blocker semantics and auto-wake rules: `skills/paperclip/references/blockers.md`.

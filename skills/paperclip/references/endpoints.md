# Paperclip Key Endpoints

Full endpoint table. For the heartbeat hot-path subset, see the cheat sheet in `SKILL.md`. For JSON response schemas and worked examples, see `api-reference.md`.
